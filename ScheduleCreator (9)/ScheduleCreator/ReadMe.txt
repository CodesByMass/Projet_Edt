...
Pour tester la fonction de génération d'EDT, veuillez selectionner la filiere S6INFO;

Pour tester la fonction de sortie Latex, veuillez lancer la fonction de génération sur la filiere S6INFO au préalable;
